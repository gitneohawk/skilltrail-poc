    ...
    <Layout>
      <div className="p-8 max-w-3xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-6">
          ...
          <p>
            <strong>氏名:</strong> {profile.basicInfo.fullName}
          </p>
          <p>
            <strong>年齢:</strong> {profile.basicInfo.age}
          </p>
          <p>
            <strong>メール:</strong> {profile.basicInfo.contact.email}
          </p>
          <p>
            <strong>郵便番号:</strong> {profile.basicInfo.address.postalCode}
          </p>
          <p>
            <strong>都道府県:</strong> {profile.basicInfo.address.prefecture}
          </p>
          <p>
            <strong>市区町村:</strong> {profile.basicInfo.address.city}
          </p>
          <p>
            <strong>住所詳細:</strong> {profile.basicInfo.address.detail}
          </p>
          <p>
            <strong>希望勤務地:</strong>{' '}
            {profile.basicInfo.workLocationPreferences?.join(', ')}
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-6">
          ...
          <p>
            <strong>希望職種:</strong>{' '}
            {profile.careerPreferences?.desiredJobTitles?.join(', ')}
          </p>
          <p>
            <strong>その他希望職種:</strong>{' '}
            {profile.careerPreferences?.otherDesiredJobTitle || 'なし'}
          </p>
          <p>
            <strong>勤務形態:</strong>{' '}
            {profile.careerPreferences?.hybridPreference?.mode === 'Onsite' &&
              '出社'}
            {profile.careerPreferences?.hybridPreference?.mode === 'Remote' &&
              'フルリモート勤務'}
          ...
          <p>
            <strong>資格:</strong> {profile.certifications?.join(', ')}
          </p>
          <p>
            <strong>その他資格:</strong> {profile.certificationsOther || 'なし'}
          </p>
        </div>
